...
const CAN_MSG_ID_M3FC_SET_CFG_PROFILE = CAN_ID_M3FC | msg_id(1);
const CAN_MSG_ID_M3FC_SET_CFG_PYROS = CAN_ID_M3FC | msg_id(2);
const CAN_MSG_ID_M3FC_LOAD_CFG = CAN_ID_M3FC | msg_id(3);
const CAN_MSG_ID_M3FC_SAVE_CFG = CAN_ID_M3FC | msg_id(4);
const CAN_MSG_ID_M3FC_MOCK_ENABLE = CAN_ID_M3FC | msg_id(5);
const CAN_MSG_ID_M3FC_MOCK_ACCEL = CAN_ID_M3FC | msg_id(6);
const CAN_MSG_ID_M3FC_MOCK_BARO = CAN_ID_M3FC | msg_id(7);
const CAN_MSG_ID_M3FC_ARM = CAN_ID_M3FC | msg_id(8);
const CAN_MSG_ID_M3FC_FIRE = CAN_ID_M3FC | msg_id(9);
const CAN_MSG_ID_M3FC_MISSION_STATE = CAN_ID_M3FC | msg_id(32);
const CAN_MSG_ID_M3FC_ACCEL = CAN_ID_M3FC | msg_id(48);
const CAN_MSG_ID_M3FC_BARO = CAN_ID_M3FC | msg_id(49);
const CAN_MSG_ID_M3FC_SE_T_H = CAN_ID_M3FC | msg_id(50);
const CAN_MSG_ID_M3FC_SE_V_A = CAN_ID_M3FC | msg_id(51);
const CAN_MSG_ID_M3FC_SE_VAR_H = CAN_ID_M3FC | msg_id(52);
const CAN_MSG_ID_M3FC_SE_VAR_V_A = CAN_ID_M3FC | msg_id(53);
const CAN_MSG_ID_M3FC_CFG_PROFILE = CAN_ID_M3FC | msg_id(54);
const CAN_MSG_ID_M3FC_CFG_PYROS = CAN_ID_M3FC | msg_id(55);
const CAN_MSG_ID_M3FC_CFG_ACCEL_CAL_X = CAN_ID_M3FC | msg_id(56);
const CAN_MSG_ID_M3FC_CFG_ACCEL_CAL_Y = CAN_ID_M3FC | msg_id(57);
