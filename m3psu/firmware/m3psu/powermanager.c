...
void PowerManager_init(){
  ...
  // Setup all LTC3887s
  ltc3887_init(&LTC3887s[0], &I2C_DRIVER, 0x40, "Cameras", 5.0f, "Pyro MCU", 3.3f);
  ltc3887_init(&LTC3887s[1], &I2C_DRIVER, 0x41, "Radio Amp", 5.0f, "Radio MCU", 3.3f);
  ltc3887_init(&LTC3887s[2], &I2C_DRIVER, 0x42, "5V AUX 1", 5.0f, "IMU ADIS", 5.0f);
  ltc3887_init(&LTC3887s[3], &I2C_DRIVER, 0x43, "CAN TRXs", 5.0f, "IMU Other", 3.3f);
  ltc3887_init(&LTC3887s[4], &I2C_DRIVER, 0x44, "5V AUX 2", 5.0f, "FC MCU", 3.3f);
  ltc3887_init(&LTC3887s[5], &I2C_DRIVER, 0x45, "3V3 AUX", 3.3f, "DL MCU", 3.3f);
