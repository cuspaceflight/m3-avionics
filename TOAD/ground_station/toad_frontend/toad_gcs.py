...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 723, 732))
        self.scrollAreaWidgetContents.setObjectName(_fromUtf8("scrollAreaWidgetContents"))
        self.gridLayout = QtGui.QGridLayout(self.scrollAreaWidgetContents)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.frame_2 = toad_frame(self.scrollAreaWidgetContents)
        self.frame_2.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtGui.QFrame.Raised)
        self.frame_2.setObjectName(_fromUtf8("frame_2"))
        self.gridLayout.addWidget(self.frame_2, 0, 1, 1, 1)
        self.frame_5 = toad_frame(self.scrollAreaWidgetContents)
        ...
        self.frame_6 = toad_frame(self.scrollAreaWidgetContents)
        self.frame_6.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame_6.setFrameShadow(QtGui.QFrame.Raised)
        self.frame_6.setObjectName(_fromUtf8("frame_6"))
        self.gridLayout.addWidget(self.frame_6, 1, 2, 1, 1)
        self.frame_4 = toad_frame(self.scrollAreaWidgetContents)
        self.frame_4.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame_4.setFrameShadow(QtGui.QFrame.Raised)
        self.frame_4.setObjectName(_fromUtf8("frame_4"))
        self.gridLayout.addWidget(self.frame_4, 1, 3, 1, 1)
        self.frame_3 = toad_frame(self.scrollAreaWidgetContents)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 645, 559))
        ...
        self.HeightLabel = QtGui.QLabel(self.scrollAreaWidgetContents_2)
        self.HeightLabel.setMaximumSize(QtCore.QSize(150, 16777215))
        self.HeightLabel.setWordWrap(True)
        self.HeightLabel.setObjectName(_fromUtf8("HeightLabel"))
        self.formLayout.setWidget(2, QtGui.QFormLayout.LabelRole, self.HeightLabel)
        self.HeightLineEdit = QtGui.QLineEdit(self.scrollAreaWidgetContents_2)
        self.HeightLineEdit.setMaximumSize(QtCore.QSize(500, 16777215))
        self.HeightLineEdit.setObjectName(_fromUtf8("HeightLineEdit"))
        self.formLayout.setWidget(2, QtGui.QFormLayout.FieldRole, self.HeightLineEdit)
        ...
        self.formLayout.setWidget(4, QtGui.QFormLayout.SpanningRole, self.label_displacement)
        self.dxLabel = QtGui.QLabel(self.scrollAreaWidgetContents_2)
        self.dxLabel.setObjectName(_fromUtf8("dxLabel"))
        self.formLayout.setWidget(5, QtGui.QFormLayout.LabelRole, self.dxLabel)
        ...
        self.formLayout.setWidget(5, QtGui.QFormLayout.FieldRole, self.dxLineEdit)
        self.dyLabel = QtGui.QLabel(self.scrollAreaWidgetContents_2)
        self.dyLabel.setObjectName(_fromUtf8("dyLabel"))
        self.formLayout.setWidget(6, QtGui.QFormLayout.LabelRole, self.dyLabel)
        ...
        self.formLayout.setWidget(6, QtGui.QFormLayout.FieldRole, self.dyLineEdit)
        self.dzLabel = QtGui.QLabel(self.scrollAreaWidgetContents_2)
        self.dzLabel.setObjectName(_fromUtf8("dzLabel"))
        self.formLayout.setWidget(7, QtGui.QFormLayout.LabelRole, self.dzLabel)
        ...
        self.formLayout.setWidget(7, QtGui.QFormLayout.FieldRole, self.dzLineEdit)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.HeightLabel.setText(_translate("MainWindow", "Height (above pad)", None))
