...
#define LINE_ANT_EN                    PAL_LINE(GPIOC, 15U)
...
#define LINE_RADIO_CS                  PAL_LINE(GPIOA, 3U)
 ...
 * PA9  - PIN9                         (unused).
 * PA10 - PIN10                        (unused).
 * PA11 - RADIO_IRQ_N                  (input, pushpull, pullup).
 * PA12 - RADIO_GPIO1                  (input).
 ...
 * PC4  - PIN4                         (unused).
 * PC5  - PIN5                         (unused).
 * PC6  - RADIO_SDN                    (output, starthigh, pushpull).
 * PC7  - PIN7                         (unused).
 * PC8  - PIN8                         (unused).
 * PC9  - PIN9                         (unused).
 * PC10 - PIN10                        (unused).
 ...
 * PC13 - PIN13                        (unused).
 * PC14 - ANT_FLAG_N                   ().
 * PC15 - ANT_EN                       (output, pushpull, startlow).
*/
...
#define VAL_GPIOC_OTYPER               (PIN_OTYPE_PUSHPULL(GPIOC_PIN0) | \
                                        ...
                                        PIN_OTYPE_PUSHPULL(GPIOC_ANT_EN))
