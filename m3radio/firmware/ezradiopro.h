...
#define EZRP_MODEM_RSSI_CONTROL_CHECK_THRESH_AT_LATCH_DISABLE   (0<<5)
#define EZRP_MODEM_RSSI_CONTROL_CHECK_THRESH_AT_LATCH_ENABLE    (1<<5)
#define EZRP_MODEM_RSSI_CONTROL_AVERAGE_AVERAGE4                (0<<3)
#define EZRP_MODEM_RSSI_CONTROL_AVERAGE_AVERAGE2                (1<<3)
#define EZRP_MODEM_RSSI_CONTROL_AVERAGE_BIT1                    (2<<3)
#define EZRP_MODEM_RSSI_CONTROL_AVERAGE_SAMPLE1                 (3<<3)
#define EZRP_MODEM_RSSI_CONTROL_LATCH_DISABLED                  (0<<0)
#define EZRP_MODEM_RSSI_CONTROL_LATCH_PREAMBLE                  (1<<0)
#define EZRP_MODEM_RSSI_CONTROL_LATCH_SYNC                      (2<<0)
#define EZRP_MODEM_RSSI_CONTROL_LATCH_RX_STATE1                 (3<<0)
#define EZRP_MODEM_RSSI_CONTROL_LATCH_RX_STATE2                 (4<<0)
#define EZRP_MODEM_RSSI_CONTROL_LATCH_RX_STATE3                 (5<<0)
#define EZRP_MODEM_RSSI_CONTROL_LATCH_RX_STATE4                 (6<<0)
#define EZRP_MODEM_RSSI_CONTROL_LATCH_RX_STATE5                 (7<<0)

#define EZRP_MODEM_RSSI_CONTROL2_RSSIJMP_DWN_DISABLED           (0<<5)
#define EZRP_MODEM_RSSI_CONTROL2_RSSIJMP_DWN_ENABLED            (1<<5)
#define EZRP_MODEM_RSSI_CONTROL2_RSSIJMP_UP_DISABLED            (0<<4)
#define EZRP_MODEM_RSSI_CONTROL2_RSSIJMP_UP_ENABLED             (1<<4)
#define EZRP_MODEM_RSSI_CONTROL2_ENRSSIJMP_DISABLED             (0<<3)
#define EZRP_MODEM_RSSI_CONTROL2_ENRSSIJMP_ENABLED              (1<<3)
#define EZRP_MODEM_RSSI_CONTROL2_JMPDLYLEN_2TB                  (0<<2)
#define EZRP_MODEM_RSSI_CONTROL2_JMPDLYLEN_4TB                  (1<<2)
#define EZRP_MODEM_RSSI_CONTROL2_ENJMPRX_DISABLED               (0<<1)
#define EZRP_MODEM_RSSI_CONTROL2_ENJMPRX_ENABLED                (1<<1)
