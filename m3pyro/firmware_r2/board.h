...
#define GPIOA_LED_RED                  0U
#define GPIOA_LED_YLW                  1U
#define GPIOA_LED_GRN                  2U
#define GPIOA_PIN3                     3U
#define GPIOA_SI_DIV                   4U
#define GPIOA_BUS_DIV                  5U
#define GPIOA_CONT                     6U
#define GPIOA_CONT_EN                  7U
#define GPIOA_CONT_PASSTHROUGH         8U
#define GPIOA_BUS_DIV_PASSTHROUGH      9U
#define GPIOA_1A_EN                    10U
#define GPIOA_SI_DIV_PASSTHROUGH       11U
#define GPIOA_3A_EN                    12U
...
#define GPIOB_3V3_PASSTHROUGH          7U
#define GPIOB_CAN_RX                   8U
#define GPIOB_CAN_TX                   9U
#define GPIOB_PIN10                    10U
#define GPIOB_PIN11                    11U
#define GPIOB_CH1                      12U
#define GPIOB_CH5                      13U
#define GPIOB_PIN14                    14U
#define GPIOB_CH2                      15U
...
#define GPIOC_CH3                      7U
#define GPIOC_CH7                      8U
#define GPIOC_CONT_EN_PASSTHROUGH      9U
...
#define LINE_1A_EN                     PAL_LINE(GPIOA, 10U)
#define LINE_3A_EN                     PAL_LINE(GPIOA, 12U)
#define LINE_3V3_PASSTHROUGH           PAL_LINE(GPIOB, 7U)
#define LINE_BUS_DIV                   PAL_LINE(GPIOA, 5U)
#define LINE_BUS_DIV_PASSTHROUGH       PAL_LINE(GPIOA, 9U)
#define LINE_CAN_RX                    PAL_LINE(GPIOB, 8U)
#define LINE_CAN_TX                    PAL_LINE(GPIOB, 9U)
#define LINE_CH1                       PAL_LINE(GPIOB, 12U)
#define LINE_CH2                       PAL_LINE(GPIOB, 15U)
#define LINE_CH3                       PAL_LINE(GPIOC, 7U)
#define LINE_CH4                       PAL_LINE(GPIOC, 4U)
#define LINE_CH5                       PAL_LINE(GPIOB, 13U)
#define LINE_CH6                       PAL_LINE(GPIOC, 6U)
#define LINE_CH7                       PAL_LINE(GPIOC, 8U)
#define LINE_CH8                       PAL_LINE(GPIOC, 5U)
#define LINE_CONT                      PAL_LINE(GPIOA, 6U)
#define LINE_CONT_EN                   PAL_LINE(GPIOA, 7U)
#define LINE_CONT_EN_PASSTHROUGH       PAL_LINE(GPIOC, 9U)
#define LINE_CONT_PASSTHROUGH          PAL_LINE(GPIOA, 8U)
...
#define LINE_LED_GRN                   PAL_LINE(GPIOA, 2U)
#define LINE_LED_RED                   PAL_LINE(GPIOA, 0U)
#define LINE_LED_YLW                   PAL_LINE(GPIOA, 1U)
#define LINE_NJTRST                    PAL_LINE(GPIOB, 4U)
#define LINE_SI_DIV                    PAL_LINE(GPIOA, 4U)
#define LINE_SI_DIV_PASSTHROUGH        PAL_LINE(GPIOA, 11U)
 ...
 *  GPIOA setup:
 *
 * PA0  - LED_RED                      (output, startlow, floating).
 * PA1  - LED_YLW                      (output, startlow, floating).
 * PA2  - LED_GRN                      (output, startlow, floating).
 * PA3  - PIN3                         (unused).
 * PA4  - SI_DIV                       (analog, floating).
 * PA5  - BUS_DIV                      (analog, floating).
 * PA6  - CONT                         (analog, floating).
 * PA7  - CONT_EN                      (output, startlow, floating).
 * PA8  - CONT_PASSTHROUGH             (input, floating).
 * PA9  - BUS_DIV_PASSTHROUGH          (input, floating).
 * PA10 - 1A_EN                        (output, startlow, floating).
 * PA11 - SI_DIV_PASSTHROUGH           (input, floating).
 * PA12 - 3A_EN                        (output, startlow, floating).
 * PA13 - JTMS                         (af0, pulldown).
 * PA14 - JTCK                         (af0, pulldown).
 * PA15 - JTDI                         (af0, pullup).
*/
#define VAL_GPIOA_MODER                (PIN_MODE_OUTPUT(GPIOA_LED_RED) | \
                                        PIN_MODE_OUTPUT(GPIOA_LED_YLW) | \
                                        PIN_MODE_OUTPUT(GPIOA_LED_GRN) | \
                                        PIN_MODE_INPUT(GPIOA_PIN3) | \
                                        PIN_MODE_ANALOG(GPIOA_SI_DIV) | \
                                        PIN_MODE_ANALOG(GPIOA_BUS_DIV) | \
                                        PIN_MODE_ANALOG(GPIOA_CONT) | \
                                        PIN_MODE_OUTPUT(GPIOA_CONT_EN) | \
                                        PIN_MODE_INPUT(GPIOA_CONT_PASSTHROUGH) | \
                                        PIN_MODE_INPUT(GPIOA_BUS_DIV_PASSTHROUGH) | \
                                        PIN_MODE_OUTPUT(GPIOA_1A_EN) | \
                                        PIN_MODE_INPUT(GPIOA_SI_DIV_PASSTHROUGH) | \
                                        PIN_MODE_OUTPUT(GPIOA_3A_EN) | \
                                        PIN_MODE_ALTERNATE(GPIOA_JTMS) | \
                                        PIN_MODE_ALTERNATE(GPIOA_JTCK) | \
                                        PIN_MODE_ALTERNATE(GPIOA_JTDI))
#define VAL_GPIOA_OTYPER               (PIN_OTYPE_PUSHPULL(GPIOA_LED_RED) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_LED_YLW) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_LED_GRN) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_PIN3) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_SI_DIV) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_BUS_DIV) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_CONT) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_CONT_EN) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_CONT_PASSTHROUGH) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_BUS_DIV_PASSTHROUGH) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_1A_EN) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_SI_DIV_PASSTHROUGH) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_3A_EN) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_JTMS) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_JTCK) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_JTDI))
#define VAL_GPIOA_OSPEEDR              (PIN_OSPEED_HIGH(GPIOA_LED_RED) | \
                                        PIN_OSPEED_HIGH(GPIOA_LED_YLW) | \
                                        PIN_OSPEED_HIGH(GPIOA_LED_GRN) | \
                                        PIN_OSPEED_HIGH(GPIOA_PIN3) | \
                                        PIN_OSPEED_HIGH(GPIOA_SI_DIV) | \
                                        PIN_OSPEED_HIGH(GPIOA_BUS_DIV) | \
                                        PIN_OSPEED_HIGH(GPIOA_CONT) | \
                                        PIN_OSPEED_HIGH(GPIOA_CONT_EN) | \
                                        PIN_OSPEED_HIGH(GPIOA_CONT_PASSTHROUGH) | \
                                        PIN_OSPEED_HIGH(GPIOA_BUS_DIV_PASSTHROUGH) | \
                                        PIN_OSPEED_HIGH(GPIOA_1A_EN) | \
                                        PIN_OSPEED_HIGH(GPIOA_SI_DIV_PASSTHROUGH) | \
                                        PIN_OSPEED_HIGH(GPIOA_3A_EN) | \
                                        PIN_OSPEED_HIGH(GPIOA_JTMS) | \
                                        PIN_OSPEED_HIGH(GPIOA_JTCK) | \
                                        PIN_OSPEED_HIGH(GPIOA_JTDI))
#define VAL_GPIOA_PUPDR                (PIN_PUPD_FLOATING(GPIOA_LED_RED) | \
                                        PIN_PUPD_FLOATING(GPIOA_LED_YLW) | \
                                        PIN_PUPD_FLOATING(GPIOA_LED_GRN) | \
                                        PIN_PUPD_PULLUP(GPIOA_PIN3) | \
                                        PIN_PUPD_FLOATING(GPIOA_SI_DIV) | \
                                        PIN_PUPD_FLOATING(GPIOA_BUS_DIV) | \
                                        PIN_PUPD_FLOATING(GPIOA_CONT) | \
                                        PIN_PUPD_FLOATING(GPIOA_CONT_EN) | \
                                        PIN_PUPD_FLOATING(GPIOA_CONT_PASSTHROUGH) | \
                                        PIN_PUPD_FLOATING(GPIOA_BUS_DIV_PASSTHROUGH) | \
                                        PIN_PUPD_FLOATING(GPIOA_1A_EN) | \
                                        PIN_PUPD_FLOATING(GPIOA_SI_DIV_PASSTHROUGH) | \
                                        PIN_PUPD_FLOATING(GPIOA_3A_EN) | \
                                        PIN_PUPD_PULLDOWN(GPIOA_JTMS) | \
                                        PIN_PUPD_PULLDOWN(GPIOA_JTCK) | \
                                        PIN_PUPD_PULLUP(GPIOA_JTDI))
#define VAL_GPIOA_ODR                  (PIN_OD_LOW(GPIOA_LED_RED) | \
                                        PIN_OD_LOW(GPIOA_LED_YLW) | \
                                        PIN_OD_LOW(GPIOA_LED_GRN) | \
                                        PIN_OD_HIGH(GPIOA_PIN3) | \
                                        PIN_OD_HIGH(GPIOA_SI_DIV) | \
                                        PIN_OD_HIGH(GPIOA_BUS_DIV) | \
                                        PIN_OD_HIGH(GPIOA_CONT) | \
                                        PIN_OD_LOW(GPIOA_CONT_EN) | \
                                        PIN_OD_HIGH(GPIOA_CONT_PASSTHROUGH) | \
                                        PIN_OD_HIGH(GPIOA_BUS_DIV_PASSTHROUGH) | \
                                        PIN_OD_LOW(GPIOA_1A_EN) | \
                                        PIN_OD_HIGH(GPIOA_SI_DIV_PASSTHROUGH) | \
                                        PIN_OD_LOW(GPIOA_3A_EN) | \
                                        PIN_OD_HIGH(GPIOA_JTMS) | \
                                        PIN_OD_HIGH(GPIOA_JTCK) | \
                                        PIN_OD_HIGH(GPIOA_JTDI))
#define VAL_GPIOA_AFRL                 (PIN_AFIO_AF(GPIOA_LED_RED, 0U) | \
                                        PIN_AFIO_AF(GPIOA_LED_YLW, 0U) | \
                                        PIN_AFIO_AF(GPIOA_LED_GRN, 0U) | \
                                        PIN_AFIO_AF(GPIOA_PIN3, 0U) | \
                                        PIN_AFIO_AF(GPIOA_SI_DIV, 0U) | \
                                        PIN_AFIO_AF(GPIOA_BUS_DIV, 0U) | \
                                        PIN_AFIO_AF(GPIOA_CONT, 0U) | \
                                        PIN_AFIO_AF(GPIOA_CONT_EN, 0U))
#define VAL_GPIOA_AFRH                 (PIN_AFIO_AF(GPIOA_CONT_PASSTHROUGH, 0U) | \
                                        PIN_AFIO_AF(GPIOA_BUS_DIV_PASSTHROUGH, 0U) | \
                                        PIN_AFIO_AF(GPIOA_1A_EN, 0U) | \
                                        PIN_AFIO_AF(GPIOA_SI_DIV_PASSTHROUGH, 0U) | \
                                        PIN_AFIO_AF(GPIOA_3A_EN, 0U) | \
 ...
 * PB5  - PIN5                         (unused).
 * PB6  - PIN6                         (unused).
 * PB7  - 3V3_PASSTHROUGH              (input, floating).
 * PB8  - CAN_RX                       (af9).
 * PB9  - CAN_TX                       (af9).
 * PB10 - PIN10                        (unused).
 * PB11 - PIN11                        (unused).
 * PB12 - CH1                          (output, startlow, floating).
 * PB13 - CH5                          (output, startlow, floating).
 * PB14 - PIN14                        (unused).
 * PB15 - CH2                          (output, startlow, floating).
*/
 ...
 * PC2  - PIN2                         (unused).
 * PC3  - PIN3                         (unused).
 * PC4  - CH4                          (output, startlow, floating).
 * PC5  - CH8                          (output, startlow, floating).
 * PC6  - CH6                          (output, startlow, floating).
 * PC7  - CH3                          (output, startlow, floating).
 * PC8  - CH7                          (output, startlow, floating).
 * PC9  - CONT_EN_PASSTHROUGH          (input, floating).
 * PC10 - PIN10                        (unused).
 * PC11 - PIN11                        (unused).
 * PC12 - PIN12                        (unused).
 * PC13 - PIN13                        (unused).
...
#define VAL_GPIOC_MODER                (PIN_MODE_INPUT(GPIOC_PIN0) | \
                                        ...
                                        PIN_MODE_OUTPUT(GPIOC_CH4) | \
                                        PIN_MODE_OUTPUT(GPIOC_CH8) | \
                                        PIN_MODE_OUTPUT(GPIOC_CH6) | \
                                        PIN_MODE_OUTPUT(GPIOC_CH3) | \
                                        PIN_MODE_OUTPUT(GPIOC_CH7) | \
                                        PIN_MODE_INPUT(GPIOC_CONT_EN_PASSTHROUGH) | \
...
#define VAL_GPIOC_OTYPER               (PIN_OTYPE_PUSHPULL(GPIOC_PIN0) | \
                                        ...
                                        PIN_OTYPE_PUSHPULL(GPIOC_CH4) | \
                                        PIN_OTYPE_PUSHPULL(GPIOC_CH8) | \
                                        PIN_OTYPE_PUSHPULL(GPIOC_CH6) | \
                                        PIN_OTYPE_PUSHPULL(GPIOC_CH3) | \
                                        PIN_OTYPE_PUSHPULL(GPIOC_CH7) | \
                                        PIN_OTYPE_PUSHPULL(GPIOC_CONT_EN_PASSTHROUGH) | \
...
#define VAL_GPIOC_OSPEEDR              (PIN_OSPEED_HIGH(GPIOC_PIN0) | \
                                        ...
                                        PIN_OSPEED_HIGH(GPIOC_CH4) | \
                                        PIN_OSPEED_HIGH(GPIOC_CH8) | \
                                        PIN_OSPEED_HIGH(GPIOC_CH6) | \
                                        PIN_OSPEED_HIGH(GPIOC_CH3) | \
                                        PIN_OSPEED_HIGH(GPIOC_CH7) | \
                                        PIN_OSPEED_HIGH(GPIOC_CONT_EN_PASSTHROUGH) | \
...
#define VAL_GPIOC_PUPDR                (PIN_PUPD_PULLUP(GPIOC_PIN0) | \
                                        ...
                                        PIN_PUPD_FLOATING(GPIOC_CH4) | \
                                        PIN_PUPD_FLOATING(GPIOC_CH8) | \
                                        PIN_PUPD_FLOATING(GPIOC_CH6) | \
                                        PIN_PUPD_FLOATING(GPIOC_CH3) | \
                                        PIN_PUPD_FLOATING(GPIOC_CH7) | \
                                        PIN_PUPD_FLOATING(GPIOC_CONT_EN_PASSTHROUGH) | \
...
#define VAL_GPIOC_ODR                  (PIN_OD_HIGH(GPIOC_PIN0) | \
                                        ...
                                        PIN_OD_LOW(GPIOC_CH4) | \
                                        PIN_OD_LOW(GPIOC_CH8) | \
                                        PIN_OD_LOW(GPIOC_CH6) | \
                                        PIN_OD_LOW(GPIOC_CH3) | \
                                        PIN_OD_LOW(GPIOC_CH7) | \
                                        PIN_OD_HIGH(GPIOC_CONT_EN_PASSTHROUGH) | \
...
#define VAL_GPIOC_AFRL                 (PIN_AFIO_AF(GPIOC_PIN0, 0U) | \
                                        ...
                                        PIN_AFIO_AF(GPIOC_CH4, 0U) | \
                                        PIN_AFIO_AF(GPIOC_CH8, 0U) | \
                                        PIN_AFIO_AF(GPIOC_CH6, 0U) | \
                                        PIN_AFIO_AF(GPIOC_CH3, 0U))
#define VAL_GPIOC_AFRH                 (PIN_AFIO_AF(GPIOC_CH7, 0U) | \
                                        PIN_AFIO_AF(GPIOC_CONT_EN_PASSTHROUGH, 0U) | \
