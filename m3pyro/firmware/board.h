...
#define GPIOA_FIRE4                    0U
#define GPIOA_CONT2                    1U
#define GPIOA_CONT1                    2U
...
#define GPIOB_FIRE1                    12U
#define GPIOB_FIRE2                    13U
#define GPIOB_PIN14                    14U
#define GPIOB_PIN15                    15U

#define GPIOC_PIN0                     0U
#define GPIOC_CONT3                    1U
#define GPIOC_FIRE3                    2U
#define GPIOC_CONT4                    3U
...
#define LINE_CONT1                     PAL_LINE(GPIOA, 2U)
#define LINE_CONT2                     PAL_LINE(GPIOA, 1U)
#define LINE_CONT3                     PAL_LINE(GPIOC, 1U)
#define LINE_CONT4                     PAL_LINE(GPIOC, 3U)
#define LINE_FIRE1                     PAL_LINE(GPIOB, 12U)
#define LINE_FIRE2                     PAL_LINE(GPIOB, 13U)
#define LINE_FIRE3                     PAL_LINE(GPIOC, 2U)
#define LINE_FIRE4                     PAL_LINE(GPIOA, 0U)
...
#define VAL_GPIOA_OTYPER               (PIN_OTYPE_PUSHPULL(GPIOA_FIRE4) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_CONT2) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_CONT1) | \
...
#define VAL_GPIOA_OSPEEDR              (PIN_OSPEED_HIGH(GPIOA_FIRE4) | \
                                        PIN_OSPEED_HIGH(GPIOA_CONT2) | \
                                        PIN_OSPEED_HIGH(GPIOA_CONT1) | \
...
#define VAL_GPIOA_PUPDR                (PIN_PUPD_PULLUP(GPIOA_FIRE4) | \
                                        PIN_PUPD_FLOATING(GPIOA_CONT2) | \
                                        PIN_PUPD_FLOATING(GPIOA_CONT1) | \
...
#define VAL_GPIOA_ODR                  (PIN_OD_LOW(GPIOA_FIRE4) | \
                                        PIN_OD_HIGH(GPIOA_CONT2) | \
                                        PIN_OD_HIGH(GPIOA_CONT1) | \
...
#define VAL_GPIOA_AFRL                 (PIN_AFIO_AF(GPIOA_FIRE4, 0U) | \
                                        PIN_AFIO_AF(GPIOA_CONT2, 0U) | \
                                        PIN_AFIO_AF(GPIOA_CONT1, 0U) | \
 ...
 * PB10 - PIN10                        (unused).
 * PB11 - PIN11                        (unused).
 * PB12 - FIRE1                        (output, startlow).
 * PB13 - FIRE2                        (output, startlow).
 * PB14 - PIN14                        (unused).
 * PB15 - PIN15                        (unused).
*/
...
#define VAL_GPIOB_OTYPER               (PIN_OTYPE_PUSHPULL(GPIOB_PIN0) | \
                                        ...
                                        PIN_OTYPE_PUSHPULL(GPIOB_FIRE1) | \
...
#define VAL_GPIOB_AFRH                 (PIN_AFIO_AF(GPIOB_CAN_RX, 9U) | \
                                        ...
                                        PIN_AFIO_AF(GPIOB_FIRE1, 0U) | \
                                        PIN_AFIO_AF(GPIOB_FIRE2, 0U) | \
...
#define VAL_GPIOC_OTYPER               (PIN_OTYPE_PUSHPULL(GPIOC_PIN0) | \
                                        PIN_OTYPE_PUSHPULL(GPIOC_CONT3) | \
                                        PIN_OTYPE_PUSHPULL(GPIOC_FIRE3) | \
                                        PIN_OTYPE_PUSHPULL(GPIOC_CONT4) | \
...
#define VAL_GPIOC_OSPEEDR              (PIN_OSPEED_HIGH(GPIOC_PIN0) | \
                                        PIN_OSPEED_HIGH(GPIOC_CONT3) | \
                                        PIN_OSPEED_HIGH(GPIOC_FIRE3) | \
                                        PIN_OSPEED_HIGH(GPIOC_CONT4) | \
...
#define VAL_GPIOC_PUPDR                (PIN_PUPD_PULLUP(GPIOC_PIN0) | \
                                        PIN_PUPD_FLOATING(GPIOC_CONT3) | \
                                        PIN_PUPD_PULLUP(GPIOC_FIRE3) | \
                                        PIN_PUPD_FLOATING(GPIOC_CONT4) | \
...
#define VAL_GPIOC_ODR                  (PIN_OD_HIGH(GPIOC_PIN0) | \
                                        PIN_OD_HIGH(GPIOC_CONT3) | \
                                        PIN_OD_LOW(GPIOC_FIRE3) | \
                                        PIN_OD_HIGH(GPIOC_CONT4) | \
...
#define VAL_GPIOC_AFRL                 (PIN_AFIO_AF(GPIOC_PIN0, 0U) | \
                                        PIN_AFIO_AF(GPIOC_CONT3, 0U) | \
                                        PIN_AFIO_AF(GPIOC_FIRE3, 0U) | \
                                        PIN_AFIO_AF(GPIOC_CONT4, 0U) | \
