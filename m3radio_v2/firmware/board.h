...
/*
    Generated by gen-board.h.py based on ../../m3radio_v2/firmware/board.yaml
*/
...
#define GPIOB_PLL_SCL                  10U
#define GPIOB_PLL_SDA                  11U
...
#define LINE_GPS_PPS                   PAL_LINE(GPIOA, 5U)
...
#define LINE_RADIO_GATE                PAL_LINE(GPIOA, 8U)
 ...
 * PA7  - PIN7                         (unused).
 * PA8  - RADIO_GATE                   (output, startlow).
 * PA9  - PIN9                         (unused).
 * PA10 - PIN10                        (unused).
 * PA11 - RADIO_IRQ_N                  ().
 * PA12 - RADIO_GPIO1                  ().
...
#define VAL_GPIOA_PUPDR                (PIN_PUPD_PULLUP(GPIOA_GPS_RX) | \
                                        ...
                                        PIN_PUPD_PULLUP(GPIOA_RADIO_GATE) | \
...
#define VAL_GPIOB_MODER                (PIN_MODE_INPUT(GPIOB_PIN0) | \
                                        ...
                                        PIN_MODE_ALTERNATE(GPIOB_PLL_SCL) | \
                                        PIN_MODE_ALTERNATE(GPIOB_PLL_SDA) | \
...
#define VAL_GPIOB_OSPEEDR              (PIN_OSPEED_HIGH(GPIOB_PIN0) | \
                                        ...
                                        PIN_OSPEED_HIGH(GPIOB_PLL_SCL) | \
                                        PIN_OSPEED_HIGH(GPIOB_PLL_SDA) | \
...
#define VAL_GPIOB_PUPDR                (PIN_PUPD_PULLUP(GPIOB_PIN0) | \
                                        ...
                                        PIN_PUPD_PULLUP(GPIOB_PLL_SCL) | \
                                        PIN_PUPD_PULLUP(GPIOB_PLL_SDA) | \
...
#define VAL_GPIOB_ODR                  (PIN_OD_HIGH(GPIOB_PIN0) | \
                                        ...
                                        PIN_OD_HIGH(GPIOB_PLL_SCL) | \
                                        PIN_OD_HIGH(GPIOB_PLL_SDA) | \
...
#define VAL_GPIOB_AFRH                 (PIN_AFIO_AF(GPIOB_CAN_RX, 9U) | \
                                        ...
                                        PIN_AFIO_AF(GPIOB_PLL_SCL, 4U) | \
                                        PIN_AFIO_AF(GPIOB_PLL_SDA, 4U) | \
